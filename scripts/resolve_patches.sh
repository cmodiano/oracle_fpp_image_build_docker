...
# Le RDBMS n'a plus de numéro : AutoUpgrade résout le jeu recommandé et récupère la gold image
# correspondante. Seul le Grid, non couvert par AutoUpgrade, exige des numéros explicites.
